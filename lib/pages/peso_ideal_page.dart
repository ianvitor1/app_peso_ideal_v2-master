...
//cotroller para aplicar a mascara na altura
...
TextEditingController pesoController = TextEditingController();
  ...
  calcular() {
    try {
    // Subistitui a virgula por ponto
    String alturaInput = alturaController.text.replaceAll(',', '.');
    ...
    setState(() {
      resultPesoIdeal =
        'Peso Inválido. Por favor, insira um valor como 85,75';
    });
    return;
  }
  }
